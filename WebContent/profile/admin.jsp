...
<tbody>
                      <tr class="candidates-list">
                        ...
                        <td class="action">
    					<a href="view_company_details.jsp?company_email=<%=resultSet.getString("company_email") %>" class="btnn"><i class="fa fa-eye"></i></a>
                        </td>
                      </tr>
...
%>
              ...
              <div class="dashboard-sidebar">
                ...
                <div class="dashboard-menu">
                  <ul>
                    <li><i class="fas fa-home"></i><a href="employer-dashboard.jsp">Company Requests</a></li>
